...
class Project {
  ...
  static List<Project> get allProjects => [
    Project(
      ...
      screenshots: [
        'lib/assets/photos/newsily/1.png',
        'lib/assets/photos/newsily/2.png',
        'lib/assets/photos/newsily/3.png',
        'lib/assets/photos/newsily/4.png',
        'lib/assets/photos/newsily/5.png',
        'lib/assets/photos/newsily/6.png',
        'lib/assets/photos/newsily/7.png',
      ],
    ...
    Project(
      ...
      screenshots: [
        'lib/assets/photos/raqib/1.png',
        'lib/assets/photos/raqib/2.png',
        'lib/assets/photos/raqib/3.png',
        'lib/assets/photos/raqib/4.png',
        'lib/assets/photos/raqib/5.png',
        'lib/assets/photos/raqib/6.png',
        'lib/assets/photos/raqib/7.png',
        'lib/assets/photos/raqib/8.png',
        'lib/assets/photos/raqib/9.png',
        'lib/assets/photos/raqib/10.png',
      ],
      //TODO: add apk download url
      apkDownloadUrl:
          'https://github.com/yourusername/yourapp/releases/download/v1.0.0/app-release.apk',
