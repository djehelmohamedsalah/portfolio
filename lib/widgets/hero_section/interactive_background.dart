        ...
        children: [
          ...
          if (!isMobile)
            Positioned.fill(
              child: RepaintBoundary(
                child: CustomPaint(
                  painter: _SpotlightPainter(mousePosition: _lerpedPosition),
                ),
              ),
            ),
...
class _MeshPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final color1 = colorScheme.primary.withOpacity(0.15);
    final color2 = colorScheme.secondary.withOpacity(0.15);
  ...
  void _drawBlob({
    ...
    final paint = Paint()
      ...
      ..blendMode = BlendMode.screen; // Better luminous blending
...
class _SpotlightPainter extends CustomPainter {
  ...
  _SpotlightPainter({required this.mousePosition})
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final paint = Paint()
      ..shader = RadialGradient(
        colors: [
          Colors.white.withOpacity(0.03), // Very subtle premium glow layer
          Colors.white.withOpacity(0.0),
        ],
        stops: const [0.0, 1.0],
      ).createShader(Rect.fromCircle(center: mousePosition.value!, radius: 225))
      ..blendMode = BlendMode
          .plus; // Aggressive light additive mix suitable for spotlight beams
